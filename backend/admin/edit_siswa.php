...
// Ambil data siswa berdasarkan NISN dari URL
$nisn = $_GET['nisn'];
...
if (isset($_POST['update'])) {
    ...
    $update = mysqli_query($koneksi, "UPDATE siswa SET nis='$nis', nama='$nama', id_kelas='$id_kelas', alamat='$alamat', no_telp='$no_telp', id_spp='$id_spp' WHERE nisn='$nisn'");
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
        <h1 class="h3 fw-bold">Edit Data Siswa</h1>
    </div>
        ...
        <div class="card-body">
            <form method="POST" action="">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="<?php echo $siswa['nisn']; ?>" disabled>
                </div>
                <div class="mb-3">
                    <label class="form-label">NIS</label>
                    <input type="text" name="nis" class="form-control" value="<?php echo $siswa['nis']; ?>" required maxlength="8">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="no_telp" class="form-control" value="<?php echo $siswa['no_telp']; ?>" required maxlength="13">
                </div>
                <div class="mb-3">
                ...
                <button type="submit" name="update" class="btn btn-success"><i class="bi bi-check-circle me-1"></i> Update Data</button>
