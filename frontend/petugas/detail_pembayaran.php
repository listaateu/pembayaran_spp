...
/* ============================================================
   DETAIL PEMBAYARAN (versi petugas)
   Mendukung 2 mode:
   - 1 id_pembayaran   -> tampilan detail satu transaksi
   - beberapa id (ids) -> tampilan gabungan (entri pembayaran multi-bulan)
   ============================================================ */
...
$currentPage = 'transaksi.php'; // tetap sorot menu Entri Transaksi, karena ini bagian dari alur bayar
$extraHeadStyle = '
        @media print {
...
<?php if ($baru): ?>
    <div class="alert alert-success d-flex align-items-center no-print">
